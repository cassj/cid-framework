...
perl -pi -e "s|$BUCKETPATH|$GITPATH|g" data-collection/deploy/git-deploy-data-collection.yaml
perl -pi -e "s|$BUCKETPATH|$GITPATH|g" data-collection/deploy/git-deploy-data-read-permissions.yaml
